...
public class UserMovieController {
    ...
    @PutMapping("user/movies/{email}")
    public ResponseEntity<?> addMoviesToList(@RequestBody Movie movie, @PathVariable String email) throws UserNotFoundException {
        try{
            userMovieService.saveUserMovieToList(movie, email);
